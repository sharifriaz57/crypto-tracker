...
import { chartDataAPI, CoinsByMarketCapAPI } from '../../api/api';
...
const Content = () => {
  ...
  const searchResultCount = handleSearch().slice((page - 1) * 10, (page * 10) - 1);
        ...
        loading
          ...
          : (<>
            <TableContainer>
              <Table>
                <TableHead>
                  <TableRow sx={{ background: 'primary', color: 'text.primary' }}>
                    ...
                    <TableCell align="right" sx={{ fontWeight: '600', color: 'text.secondary' }}>24h Change %</TableCell>
