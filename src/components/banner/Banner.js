...
const Banner = () => {
    ...
    const styles = {
        banner: {
            backgroundColor: `${mode === 'light' ? '#b9d9e3' : '#25203b'}`,
    ...
    return (
        <div style={styles.banner}>
            <svg width="100%" height="100%" version="1.1" fillRule="evenodd" clipRule="evenodd" style={{ ...styles.svg, left: '10%' }}
            ...
            <svg width="100%" height="100%" version="1.1" fillRule="evenodd" clipRule="evenodd" style={{...styles.svg, right: '10%'}}
            ...
            <svg version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 2496 2496" style={{...styles.svg, right: '20%', top: '-40px' }}>
                <g>
            ...
            <Container maxWidth="lg" disableGutters sx={{ marginBottom: '3rem' }}>
                <Toolbar sx={{ flexDirection: 'column' }}>
                    ...
                    <Typography variant="button" sx={{ color: 'text.secondary', textAlign: 'center', }}>
